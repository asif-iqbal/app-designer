			...
			var methods = {
				init : function() {
					...
					function _init() {
						...
						if (_options.text) {
							waitMe_text = $('<div  class="' + elemClass + '_text" style="color:' + _options.color + '"style="font-size:20px; color#fff;"> <img src="../config/assets/img/rolling.gif" width="80px"><br> <br>' + _options.text + '</div>');
						}
